...
public class AddActivity extends AppCompatActivity {
    ...
    private void attemptAdd() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserAddTask(name, email, phone);
    ...
    private void addPersonToDB(String name, String email, String phone) {
    ...
    public class UserAddTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserAddTask(String name, String email, String phone) {
            mName = name;
            mEmail = email;
            mPhone = phone;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                addPersonToDB(mName, mEmail, mPhone);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPhoneView.setError(getString(R.string.error_phone_exists));
